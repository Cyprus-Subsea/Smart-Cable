...
/* Definitions for test_t */
osThreadId_t test_tHandle;
const osThreadAttr_t test_t_attributes = {
  .name = "test_t",
  .priority = (osPriority_t) osPriorityNormal,
  .stack_size = 256 * 4
};
...
/* USER CODE BEGIN Header_test_f */
/**
* @brief Function implementing the test_t thread.
* @param argument: Not used
* @retval None
*/
