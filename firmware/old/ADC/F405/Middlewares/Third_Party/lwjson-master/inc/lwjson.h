...
int lwJsonGetIntArray(const char **path, const LwJsonMsg *msg, int *array, uint32_t arrayLen);
int lwJsonGetStringArray(const char **path, const LwJsonMsg *msg, char **pArray, uint32_t *pLen, uint32_t arrayLen);
...
int lwJsonAddIntToArray(LwJsonMsg *msg, int32_t value);
