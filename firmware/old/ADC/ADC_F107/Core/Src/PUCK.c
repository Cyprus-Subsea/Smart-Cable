...
const puck_datasheet_type sensor_default_datasheet={{0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x08,0x09,0x0A,0x0B,0x0C,0x0D,0x0E,0x0F,0x10},3,96,0,0,0,2103416,"Smart-Cable/Cyclops-7/Turner Design/11/05/2021"};
puck_str puck_main;
extern ssp_str ssp_main;
